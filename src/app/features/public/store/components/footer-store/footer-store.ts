...
export class FooterStore {
  ...
  readonly contactItems: ContactItem[] = [
    ...
    {
      label: 'fgperu@gmail.com',
      href: 'mailto:fgperu@gmail.com',
  ...
  readonly legalLinks: NavLink[] = [
    { label: 'Términos de Servicio',   routerLink: '/register' },
    { label: 'Política de Privacidad', routerLink: '/register' }
  ];
}
